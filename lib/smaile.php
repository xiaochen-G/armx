...
function outputjs(){
	$jsurl = Helper::options()->themeUrl.'/';
	if(Helper::options()->lazyimg){
		return "<script type=\"text/javascript\" src=\"".$jsurl."js/blazy.min.js\"></script>"."<script type=\"text/javascript\" src=\"".$jsurl."lib/smaile.js\"></script>";
	}else{
		return "<script type=\"text/javascript\" src=\"".$jsurl."lib/smaile.js\"></script>";
	}
}
